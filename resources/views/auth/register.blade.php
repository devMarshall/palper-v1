                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="f_name" type="text" class="form-control{{ $errors->has('f_name') ? ' is-invalid' : '' }}" name="f_name" value="{{ old('f_name') }}"
                                    required autofocus> @if ($errors->has('f_name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="l_name" type="text" class="form-control{{ $errors->has('l_name') ? ' is-invalid' : '' }}" name="l_name" value="{{ old('l_name') }}"
                                    required autofocus> @if ($errors->has('l_name'))
                                <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="invalid-feedback">
                                        <strong>{{ $errors->first('user_handle') }}</strong>
                                    </span> @endif
                            </div>
                        </div>
